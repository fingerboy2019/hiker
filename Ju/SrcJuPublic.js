let cfgfile = "hiker://files/rules/fingerboy/Src/Ju/config.json";
let Jucfg = fetch(cfgfile);
if (Jucfg != "") {
    eval("var Juconfig=" + Jucfg + ";");
} else {
    var Juconfig = {};
    Juconfig["依赖"] = config.依赖 || "https://raw.githubusercontent.com/fingerboy2019/hiker/Ju/SrcJuPublic.js";
...
let sourcefile = "hiker://files/rules/fingerboy/Src/Ju/jiekou.json";
